...
class ApiServices {
  ...
  final baseurl = 'https://seashell-hippopotamus-379481.hostingersite.com';

  Map<String, dynamic>? headerOption = {
    'Accept': 'application/json',
    'Authorization': 'Bearer ${CashedSharedPrefrances.getData(key: 'token')}'
  };
  ...
  Future get(
    ...
    var response = await dio.get('$baseurl$endPoint',
        ...
        data: body,
        options: Options(headers: headers ?? headerOption));
